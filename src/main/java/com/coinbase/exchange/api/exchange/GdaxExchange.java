...
public interface GdaxExchange {
    ...
    <T> T pagedGet(String endpoint, ParameterizedTypeReference<T> responseType, String beforeOrAfter, Integer
            pageNumber, Integer limit);

    <T> List<T> getAsList(String endpoint, ParameterizedTypeReference<T[]> type);

    <T> List<T> pagedGetAsList(String endpoint, ParameterizedTypeReference<T[]> responseType, String beforeOrAfter,
